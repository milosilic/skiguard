...
public class DeviceDao extends AbstractDao<Device, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Serial_number = new Property(1, String.class, "serial_number", false, "SERIAL_NUMBER");
        public final static Property Color = new Property(2, String.class, "color", false, "COLOR");
        public final static Property Name = new Property(3, String.class, "name", false, "NAME");
        public final static Property Last_update = new Property(4, Long.class, "last_update", false, "LAST_UPDATE");
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getHistoryDao().getAllColumns());
            builder.append(" FROM DEVICE T");
            builder.append(" LEFT JOIN HISTORY T0 ON T.\"LAST_UPDATE\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Device loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        History history = loadCurrentOther(daoSession.getHistoryDao(), cursor, offset);
